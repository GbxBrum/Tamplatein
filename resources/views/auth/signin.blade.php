                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="text-warning" for="email">Nama</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="d-block">
                                                    <label for="password"
                                                        class="control-label text-warning">Password</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label text-warning" for="Level">Level</label>
