            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-header bg-white">
                        <h4 class="position-absolute text-warning">Penjualan Kasir</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <div class="form-group float-right">
                                    <label class="text-warning" for="Total Belanja">Subtotal</label>
                                    <div class="input-group-prepend">
                                        <h1 class="text-warning mr-2">Rp<br></h1>
                                        <input class="d-none" type="text" id="total" value="0" name="total">
                                        <h1 class="text-warning" id="label-total">0</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
